# Primer trabajo práctico react - Hola mundo

Este es el ejercicio número 1 del primer trabajo práctico de react de la escuela de programación [Rolling Code](https://rollingcodeschool.com/). Este ejercicio tiene como finalidad ser una primera introducción a react.

Podes ver la página haciendo click [aquí](https://ejercicio01-reac-hola-mundo.netlify.app/)
